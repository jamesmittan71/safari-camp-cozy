  ...
  head: () => ({
    meta: [
      { title: "Sign in — Ten of Cups Camp Manager" },
      {
        name: "description",
        content:
          "Sign in to the Ten of Cups Camp Manager to view camp accommodation data.",
      },
      {
        property: "og:title",
        content: "Sign in — Ten of Cups Camp Manager",
      },
      {
        property: "og:description",
        content:
          "Staff access to the Ten of Cups game farm accommodation system.",
      },
