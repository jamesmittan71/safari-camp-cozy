  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2f0ca34a-7fdc-48a5-aac7-d9f84ee0e330/id-preview-ec1a9e8b--5080b3d8-49fa-4829-8a71-b2593b4fd530.lovable.app-1785931864566.png",
      },
      {
        name: "twitter:image",
        content:
